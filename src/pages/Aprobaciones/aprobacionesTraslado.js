...
class AprobacionTraslado extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
                ...
                <Container fluid>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col sm="12">
                                <h4 className="page-title">APROBACI&Oacute;N DE TRASLADO DE BIENES INDIVIDUALES</h4>
                            </Col>
                        </Row>
                    </div>
                    <Row>
                        <Col>
                            <Card>
                                <CardBody className="form-comprobante">
                                    <Row>
                                        <Col sm="12">
                                            <h5 style={{textAlign:"center"}}>¿Est&aacute; seguro que desea autorizar este traslado de bien individual? </h5>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col sm='6'>
...
export default withRouter(connect(null, { activateAuthLayout })(AprobacionTraslado));