...
class AprobacionBajaBien extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
    ...
    async submitAutorizar() {
        ...
        try {
            const res = await aceptRejectProcess(data)
            console.log(res);
                ...
                <Container fluid>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col sm="12">
                                <h4 className="page-title">APROBACI&Oacute;N DE BAJA DE BIEN</h4>
                            </Col>
                        </Row>
                    </div>
                    <Row>
                        <Col>
                            <Card>
                                <CardBody className="form-comprobante">
                                    <Row>
                                        <Col sm="12">
                                            <h5 style={{textAlign:"center"}}>¿Est&aacute; seguro que desea autorizar esta baja de bien? </h5>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col sm='6'>
...
export default withRouter(connect(null, { activateAuthLayout })(AprobacionBajaBien));