...
class AprobacionIngresoEntrada extends Component {
    constructor(props) {
        super(props);
        this.state = {
            loading: false,
                ...
                <Container fluid>
                    <div className="page-title-box">
                        <Row className="align-items-center">
                            <Col sm="12">
                                <h4 className="page-title">APROBACI&Oacute;N INGRESO DE BIEN DE ENTRADA</h4>
                            </Col>
                        </Row>
                    </div>
                    <Row>
                        <Col>
                            <Card>
                                <CardBody className="form-comprobante">
                                    <Row>
                                        <Col sm="12">
                                            <h5 style={{textAlign:"center"}}>¿Est&aacute; seguro que desea autorizar este ingreso de bien de entrada? </h5>
                                        </Col>
                                    </Row>
...
export default withRouter(connect(null, { activateAuthLayout })(AprobacionIngresoEntrada));